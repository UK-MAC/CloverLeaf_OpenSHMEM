...
SUBROUTINE clover_exchange(fields,depth)
    ...
    INTEGER, PARAMETER :: location_of_tasks_chunk = 1


    CALL clover_exchange_send_async(location_of_tasks_chunk, depth, fields)

    CALL clover_exchange_receive_async(location_of_tasks_chunk, depth, fields)

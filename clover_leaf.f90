...
PROGRAM clover_leaf
  ...
  IF(parallel%boss)THEN
      ...
      WRITE(*,'(a64)') 'SHMEM Buffers VolatileVars DiagComms MultiFields Overlap Version'
      WRITE(*,'(a14,i6)') 'Task Count ',parallel%max_task !MPI
      WRITE(*,*)
      WRITE(0,*)
      WRITE(0,'(a15,f8.3)') 'Clover Version ',g_version
      WRITE(0,'(a64)') 'SHMEM Buffers VolatileVars DiagComms MultiFields Overlap Version'

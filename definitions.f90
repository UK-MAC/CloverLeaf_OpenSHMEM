...
MODULE definitions_module
  ...
  END TYPE chunk_type
    ...
    REAL(KIND=8) :: density0(-1:62,-1:62)
    REAL(KIND=8) :: density1(-1:62,-1:62)
    REAL(KIND=8) :: energy0(-1:62,-1:62)
    REAL(KIND=8) :: energy1(-1:62,-1:62)
    REAL(KIND=8) :: pressure(-1:62,-1:62)
    REAL(KIND=8) :: viscosity(-1:62,-1:62)
    REAL(KIND=8) :: soundspeed(-1:62,-1:62)
    REAL(KIND=8) :: xvel0(-1:63,-1:63)
    REAL(KIND=8) :: xvel1(-1:63,-1:63)
    REAL(KIND=8) :: yvel0(-1:63,-1:63)
    REAL(KIND=8) :: yvel1(-1:63,-1:63)
    REAL(KIND=8) :: vol_flux_x(-1:63,-1:62)
    REAL(KIND=8) :: mass_flux_x(-1:63,-1:62)
    REAL(KIND=8) :: vol_flux_y(-1:62,-1:63)
    REAL(KIND=8) :: mass_flux_y(-1:62,-1:63)

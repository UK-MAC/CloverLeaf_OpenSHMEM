...
MODULE definitions_module
  ...
  POINTER (viscosity_plr,  viscoity_left_rcv_buffer)
  POINTER (viscosity_prr,  viscoity_right_rcv_buffer)
  POINTER (viscosity_pbr,  viscoity_bottom_rcv_buffer)
  POINTER (viscosity_ptr,  viscoity_top_rcv_buffer)
  POINTER (viscosity_pls,  viscoity_left_snd_buffer)
  POINTER (viscosity_prs,  viscoity_right_snd_buffer)
  POINTER (viscosity_pbs,  viscoity_bottom_snd_buffer)
  POINTER (viscosity_pts,  viscoity_top_snd_buffer)
  POINTER (viscosity_pltr, viscoity_left_top_rcv_buffer)
  POINTER (viscosity_prtr, viscoity_right_top_rcv_buffer)
  POINTER (viscosity_plbr, viscoity_left_bottom_rcv_buffer)
  POINTER (viscosity_prbr, viscoity_right_bottom_rcv_buffer)
  POINTER (viscosity_plts, viscoity_left_top_snd_buffer)
  POINTER (viscosity_prts, viscoity_right_top_snd_buffer)
  POINTER (viscosity_plbs, viscoity_left_bottom_snd_buffer)
  POINTER (viscosity_prbs, viscoity_right_bottom_snd_buffer)

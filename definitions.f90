...
MODULE definitions_module
  ...
  REAL(KIND=8):: left_snd_buffer(1),right_snd_buffer(1),bottom_snd_buffer(1),top_snd_buffer(1)
    ...
    REAL(KIND=8) :: density0(-1:482,-1:482)
    REAL(KIND=8) :: density1(-1:482,-1:482)
    REAL(KIND=8) :: energy0(-1:482,-1:482)
    REAL(KIND=8) :: energy1(-1:482,-1:482)
    REAL(KIND=8) :: pressure(-1:482,-1:482)
    REAL(KIND=8) :: viscosity(-1:482,-1:482)
    REAL(KIND=8) :: soundspeed(-1:482,-1:482)
    REAL(KIND=8) :: xvel0(-1:483,-1:483)
    REAL(KIND=8) :: xvel1(-1:483,-1:483)
    REAL(KIND=8) :: yvel0(-1:483,-1:483)
    REAL(KIND=8) :: yvel1(-1:483,-1:483)
    REAL(KIND=8) :: vol_flux_x(-1:483,-1:482)
    REAL(KIND=8) :: mass_flux_x(-1:483,-1:482)
    REAL(KIND=8) :: vol_flux_y(-1:482,-1:483)
    REAL(KIND=8) :: mass_flux_y(-1:482,-1:483)
